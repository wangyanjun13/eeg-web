    ...
    <el-form label-position="top" label-width="100px">
      ...
      <template v-if="preprocessParams.artifacts.remove_artifacts">
        <el-form-item label="检测方法">
          <el-select v-model="preprocessParams.artifacts.artifact_detection_method">
        ...
        <el-form-item label="幅度阈值 (μV)" v-if="preprocessParams.artifacts.artifact_detection_method === 'threshold'">
          <el-input-number 
